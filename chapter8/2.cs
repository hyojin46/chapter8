...
namespace chapter8
{
    public partial class _2 : Form
    {
        ...
        {
            UpdateLabel(checkBox1.Text, checkBox1.Checked); //사용자 정의함수 호출
        }

        private void checkBox4_CheckedChanged(object sender, EventArgs e) // 체크박스 이벤트 처리기
        {
            UpdateLabel(checkBox2.Text, checkBox2.Checked); //사용자 정의함수 호출
        }
        ...
        {
            UpdateLabel(checkBox4.Text, checkBox4.Checked);  //사용자 정의함수 호출
        }
    }
}
